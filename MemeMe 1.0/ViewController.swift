...
//  MemeMe 1.0
//
//  Created by Dhruv Shah on 27/07/21.
//
...
class ViewController: UIViewController, UIImagePickerControllerDelegate, UINavigationControllerDelegate, UITextFieldDelegate {
    ...
    let memeTextAttributes: [NSAttributedString.Key: Any] = [
        ...
        NSAttributedString.Key.font: UIFont(name: "HelveticaNeue", size: 40)!,
    ...
    //Save meme
    func saveMeme() {
        //let meme = MemeMeOne(topText: topTextField.text!, bottomText: bottomTextField.text!, originalImage: imageView.image!, newImage: generatingMeme())
    }
